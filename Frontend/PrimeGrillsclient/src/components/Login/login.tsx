            ...
            <div className="bg-white h-{874px} w-1/2 flex flex-col px-3 py-3 rounded-2xl">
                ...
                <form action="">
                    ...
                    <div className="relative py-3">
                        ...
                        <input type="text" id="input-group-1" className=" flex bg-white shadow-md border-t border-gray-300 text-gray-900 text-sm w-full rounded-2xl ring-orange-500 border-orange-500  ps-10 p-2.5" placeholder="Email"/>
                    ...
                    <div className="relative py-3">
                        ...
                        <input type="text" id="input-group-1" className="bg-white shadow-md border-t border-gray-300 text-gray-900 text-sm w-full rounded-2xl ring-orange-500 border-orange-500  ps-10 p-2.5" placeholder="Password"/>
