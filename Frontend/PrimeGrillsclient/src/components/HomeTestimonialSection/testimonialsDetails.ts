...
export const testimonials = [
    ...
    },
    {
        customerImage: customer,
        testimonialText:
            'An unforgettable dining experience. Every dish was a masterpiece, and the staff was incredibly friendly.',
    ...
    },
    {
        customerImage: customer,
        testimonialText:
            'A fantastic place to dine with family and friends. The menu is diverse, and everything tastes amazing.',
