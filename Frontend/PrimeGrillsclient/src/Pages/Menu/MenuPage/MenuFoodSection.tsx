...
const MenuFoodSection = () => {
  ...
  const FOOD_ITEMS = [
    ...
    { id: 4, image: menuimage3, name: "Barbecue", price: 10000,
        description: "A delicious and spicy Shawarma wrap.",
    items: ["Chicken slices", "Pita bread", "Garlic sauce"]
     },
  ...
  return (
    <div className="flex flex-col justify-self-center px-4 mx-auto mt-12 md:mt-24 w-full">
      ...
      <div className="flex justify-between items-center mb-4">
        <h1 className="text-3xl font-bold md:ml-4 text-black">Food</h1>
...
export default MenuFoodSection;